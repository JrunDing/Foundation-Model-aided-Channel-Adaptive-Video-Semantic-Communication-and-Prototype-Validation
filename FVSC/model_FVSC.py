...
class FrameCodec(nn.Module):
    ...
    def forward(self, referframe, input_image):
        """
        :brief: Perform semantic encoding and decoding of the input frame based on the reference frame
        """
        input_image = input_image/255.
        referframe = referframe/255.
        quant_semantic_feature, semantic_feature_shape = self.videocompressor(input_image, referframe)
        # wireless transmission: quant_semantic_feature
